...
import editproductview from "../routes/user/editviewproduct.routes";
import cors from 'cors';
import Buynowroutes from "../routes/user/buynow.routes";
...
export default class Routes {
  constructor(app: Application) {
   ...
   app.use(cors());
    ...
    app.use("/api/allproduct",editproductview);
